...
const _nonPdfToolsRaw: NonPdfTool[] = [
  ...
  },
  {
    ...
    metaDescription: "Pull text out of scanned documents, screenshots, and receipts using on-device OCR or a connected AI provider. Free to use, and no sign-up is required.",
  ...
  },
  {
    ...
    metaDescription: "Upload any image to create a multi-size ICO favicon ready for your website, no design skills required. Free to use, with no sign-up.",
  ...
  },
  {
    ...
    metaDescription: "Upload an image containing a QR code to reveal its decoded text or link. Free to use, with temporary server processing; linear barcodes are not supported.",
  ...
  },
  {
    ...
    longDescription: "Pixelate or blur an image to obscure sensitive content before sharing — block faces, license plates, addresses, screenshots. Choose mosaic-style pixelation or smooth Gaussian blur, adjust strength 1-100. Runs server-side; the image is cleaned up from temporary storage after the response.",
    seoTitle: "Pixelate or Blur an Image Online Free – Hide Sensitive Areas",
    metaDescription: "Censor faces, license plates, or screenshots with mosaic pixelation or a smooth Gaussian blur. Strength is adjustable, and images are removed after processing.",
  ...
  },
  {
    ...
    metaDescription: "Rotate JPG, PNG, WEBP, HEIC, and more left, right, or upside down, with the canvas auto-expanding. Files are processed and then removed automatically.",
