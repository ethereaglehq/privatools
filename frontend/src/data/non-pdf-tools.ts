...
const _nonPdfToolsRaw: NonPdfTool[] = [
  // ── Image & Media ───────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Compress JPEG, PNG, or WebP Images – Shrink File Size",
  ...
  },
  {
    ...
    seoTitle: "Convert Images Online – WebP, PNG, JPG, TIFF, or HEIC",
    metaDescription: "Change a photo between WebP, PNG, JPG, TIFF, BMP, or HEIC formats, including iPhone HEIC to JPG. Free tool with temporary server processing.",
  ...
  },
  {
    ...
    seoTitle: "Resize or Crop Images Online – Bulk Batch Processing",
    metaDescription: "Set exact dimensions, aspect ratios, or pixel sizes and resize multiple images at once for social posts or thumbnails. Free, no sign-up required.",
  ...
  },
  {
    ...
    seoTitle: "Convert Video to GIF Online – Choose the Clip Range",
    metaDescription: "Upload an MP4, MOV, or WebM file, select the clip range, and export a looping animated GIF. Free tool with adjustable FPS and no watermarks.",
  ...
  },
  {
    ...
    metaDescription: "Paste text or upload a file to get an instant MD5 or SHA checksum for verifying integrity. All hashing happens in your browser, nothing uploaded.",
  ...
  // ── Document & Office ───────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Paste or upload data to swap instantly between CSV and JSON formats. Handy for API testing or spreadsheet conversions, running entirely in your browser.",
  ...
  },
  {
    ...
    metaDescription: "Paste or upload a Markdown file to get clean, semantic HTML output with a live preview as you type. It runs in your browser, ideal for README files.",
  ...
  },
  {
    ...
    metaDescription: "Stamp photos with a customizable text watermark, choosing its position, opacity, and color. Files receive temporary processing and are then removed.",
  ...
  // ── Client-only utility tools (Round O) ────────────────────────────────────
  {
    ...
    seoTitle: "Generate a Strong Password Online Free – Live Strength",
  ...
  },
  {
    ...
    metaDescription: "Change a PNG into a JPEG that is typically much smaller, handy for email attachments and upload limits. Transparent areas turn white, with no sign-up.",
  ...
  },
  {
    ...
    metaDescription: "Change a PNG into WebP, keeping transparency while cutting file size for web graphics and apps. A lossless mode is available for pixel-perfect output.",
  ...
  },
  {
    ...
    metaDescription: "Turn an archival TIFF scan into a universally compatible JPEG file, with each page of a multi-page scan exported separately. Free to use, no sign-up.",
  ...
  },
  {
    ...
    metaDescription: "Convert a GIF to PNG and keep its transparency, with far better color quality than GIF allows. Files are processed and then removed automatically.",
  ...
  },
  {
    ...
    metaDescription: "Turn iPhone, macOS, and QuickTime MOV clips into looping GIFs using the existing video-to-GIF pipeline. Files are processed and then removed automatically.",
