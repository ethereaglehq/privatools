...
const _nonPdfToolsRaw: NonPdfTool[] = [
  ...
  },
  {
    ...
    metaDescription: "Set in and out points on a visual timeline to cut a video or audio clip down to size. Export the trimmed result at full quality, free and with no sign-up.",
  ...
  },
  {
    ...
    metaDescription: "Burn SRT or VTT subtitle files permanently into a video so captions show up on every player, including social apps. Files are processed and then removed.",
  ...
  },
  {
    ...
    metaDescription: "Swap subtitle files between SRT, VTT, and ASS so they work with whichever player you have. The conversion runs entirely in your browser, with nothing uploaded.",
