...
export const comparisons: ProductComparison[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Files and size", privatools: "Merge takes up to 100 PDFs in one 500 MB upload but stops waiting after 60 seconds; most single-file pages take up to 500 MB.", competitor: "Basic merges 25 files up to 100 MB and Premium 500 files up to 4 GB; Basic Office conversion and OCR take one 15 MB file.", sourceUrl: "https://www.ilovepdf.com/pricing" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "File size", privatools: "500 MB per upload request, which on most pages holds a single file, and some heavy pages wait 60 seconds at most.", competitor: "The free file size is marked Limited without a number, paid plans Unlimited; AI files up to 50 MB.", sourceUrl: "https://smallpdf.com/pricing" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Online file limits", privatools: "Up to 500 MB per file on most pages, but PDF to Word and OCR stop waiting after 60 seconds.", competitor: "The online PDF to Word converter takes files up to 15 MB; Foxit says its desktop version handles higher limits.", sourceUrl: "https://www.foxit.com/pdf-to-word/" },
