...
export const comparisons: ProductComparison[] = [
  {
    ...
    features: [
      ...
      { label: "File limits", privatools: "JPG, PNG, WebP or BMP. The browser engine takes up to 40 megapixels; the server engine refuses images over 300 megapixels and takes files of about 250 MB.", competitor: "JPG, PNG or WebP up to 22 MB and 50 megapixels; website previews are capped at 0.25 megapixels.", sourceUrl: "https://www.remove.bg/help/a/what-is-the-maximum-image-resolution-file-size" },
    ...
    sections: [
      ...
      { heading: "Replacing it with PrivaTools", body: [
        "PrivaTools' Background Remover returns a transparent PNG at the original dimensions, without an account, credits or a personal-use restriction. Its default server engine runs the compact U-2-Net model, u2netp, on the PrivaTools server and accepts five runs a minute from one visitor. The in-browser engine downloads the same model, about 4.4 MB plus its runtime, and then processes images on your device, so they are not uploaded for that path.",
  ...
  },
  {
    ...
    highlights: ["Per-tool limits on the free Basic plan, lifted by Premium; PrivaTools has one free tier.", "Premium desktop tools process files on your computer; PrivaTools runs in the browser.", "Files deleted within two hours there, or sooner by hand; PrivaTools cleans up after each response."],
    overview: [
    ...
    features: [
      ...
      { label: "Free-plan limits", privatools: "No daily task count; heavy tools such as OCR take five runs a minute from one visitor.", competitor: "Basic processes a limited number of documents, and tools such as OCR to Word and PDF/A are Premium only.", sourceUrl: "https://www.ilovepdf.com/pricing" },
  ...
  },
  {
    ...
    overview: [
      ...
      "Uploaded files are processed on Hetzner servers in the European Union; the privacy notice says they may be stored there temporarily and that this does not involve permanent storage. The support page says files are removed an hour after processing for most tools. AI features use OpenAI, and Smallpdf's AI terms say usage data is not shared with OpenAI to train OpenAI's models and is deleted from Smallpdf's own database after 90 days. It states that it is ISO/IEC 27001 certified.",
    ],
    features: [
      ...
      { label: "Free-plan limits", privatools: "No daily count; five runs a minute per visitor on heavy tools.", competitor: "Most tools carry a daily download limit, PDF OCR included; AI tools allow up to 4 documents a day.", sourceUrl: "https://smallpdf.com/pricing" },
    ...
    sections: [
      { heading: "What the free plan leaves out", body: [
        ...
        "PrivaTools does not count use by day. Its strongest compression preset, OCR and PDF to Word are available without an account, but heavy tools accept five runs a minute from one visitor, so a long batch partly fails and needs retries, and the OCR and PDF to Word pages stop waiting after 60 seconds, upload included. It cannot edit existing PDF text on any plan: Edit PDF adds new content on top of the page.",
      ] },
    ...
    tradeoffs: ["Its privacy notice gives different deletion rules for signed-in and signed-out use; check which applies before uploading sensitive files.", "PrivaTools' free runs have their own ceiling: heavy tools take five a minute from one visitor.", "We did not benchmark output quality or speed."],
    sources: [
  ...
  },
  {
    ...
    description: "Most of Adobe Acrobat's free online tools allow one task without signing in, and editing existing text needs a paid plan; PrivaTools is free with no account.",
    ...
    sections: [
      { heading: "Free online tools and their limits", body: [
        ...
        "PrivaTools has no trial logic. Protect PDF, Unlock PDF, compression, conversion, OCR and redaction are free on every run and need no sign-in, within the 500 MB upload cap, the five-a-minute limit on heavy tools and a 60-second wait on pages such as Protect, OCR and PDF to Word.",
      ] },
      { heading: "Where Acrobat does more", body: [
        "Acrobat edits existing text and images and adjusts the formatting, compares versions, creates web forms and reusable e-sign templates, repairs accessibility tagging in Pro and saves PDF/A, PDF/X and PDF/E files in Pro. It signs with certificates and validates signed files, and Standard and above request signatures and track responses. Its AI Assistant, included in Acrobat Express and Studio, sends content extracted from your documents to Microsoft Azure OpenAI split and encrypted, and Adobe says the documents themselves are not stored there.",
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Free-use limits", privatools: "No hourly allowance; OCR and conversions are limited to five runs a minute.", competitor: "Most free web tools: documents up to 200 pages or 50 MB, and 3 tasks per hour.", sourceUrl: "https://www.sejda.com/pdf-editor" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Platforms", privatools: "Any modern browser; installable as a web app.", competitor: "Creator for Windows only, also in the Microsoft Store; the online tools run in the browser.", sourceUrl: "https://tools.pdf24.org/en/creator" },
    ],
    sections: [
  ...
  },
  {
    ...
    choosePrivaTools: ["You need to add text, sign, annotate or redact PDFs without a licence or trial.", "Your files exceed the caps of Foxit's free online converters and you do not want the desktop editor.", "You want image, audio, video and developer tools, and code you can host."],
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Free-plan limits", privatools: "No account or daily count; each heavy tool allows five runs a minute.", competitor: "Free: files up to 10 MB, AI agent 3 questions a day, ChatPDF 1 file a day, no batch processing; paid plans lift the size cap.", sourceUrl: "https://lightpdf.com/pricing" },
    ...
    sections: [
      { heading: "AI in the plan or on your own key", body: [
        "LightPDF includes AI in its plans and meters it in credits: its pricing page lists 20 credits per ChatPDF chat, 5 per AI agent request and 5 a page for translation, or 40 a page for scanned PDFs, with extra credits for sale. Free users get three AI agent questions a day and one ChatPDF file a day of up to 100 pages. It says your data and chat contents are not used to train AI models.",
    ...
    tradeoffs: ["PrivaTools' Chat with PDF needs your own provider key, and that provider's terms and charges apply.", "PrivaTools' conversions cost nothing but are rate-limited, at five runs a minute on heavy tools.", "AI answers from either product need checking against the document; we did not test their accuracy."],
    sources: [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Free tier", privatools: "No user or seat limit, on the public site or your own server.", competitor: "The free self-hosted tier covers up to 5 users; more need a Team or Enterprise plan.", sourceUrl: "https://docs.stirlingpdf.com/Modes%20and%20Licensing/" },
      ...
      { label: "Where files are processed", privatools: "In your browser for browser-only tools, otherwise on privatools.me or your own server.", competitor: "Desktop local mode runs basic tools on the device with no sign-in; OCR, conversion, compression and repair need a server or its cloud.", sourceUrl: "https://docs.stirlingpdf.com/Modes%20and%20Licensing/" },
      ...
      { label: "Team administration", privatools: "Optional accounts, with Google or GitHub sign-in through Clerk, issue API keys; no roles, SAML or audit logs.", competitor: "OAuth2 single sign-on on Team; SAML sign-in and audit logs on Enterprise.", sourceUrl: "https://docs.stirlingpdf.com/Paid-Offerings/" },
    ],
    sections: [
    ...
    tradeoffs: ["Self-hosting either product makes you responsible for updates, backups, logs and capacity, and for how the copy you run handles files.", "PrivaTools' own code is MIT-licensed, but it depends on libraries with other licences, including PyMuPDF under the AGPL; check them before you redistribute a modified copy.", "We did not benchmark conversion quality, OCR accuracy or speed for either product."],
    sources: [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "The free plan in practice", body: [
        "DocHub's free plan fits a few documents a month: its core features share a limit of three uses a month, and Basic keeps that cap on selected Pro features while adding unlimited downloads, self-signing and templates. Pro makes PDF editing and sign requests unlimited.",
        "PrivaTools has no monthly allowance, but it has other limits: 500 MB per upload request, lower caps on some tools, such as 200 MB for Mute Video and Trim Media, a 60-second wait on pages such as OCR and PDF to Word, a five-minute limit on the server, and five runs a minute on heavy tools. It also has no account to keep documents in, so download a completed form before you leave the page.",
      ] },
    ],
    ...
    choosePrivaTools: ["You need a conversion, page operation or form fill without creating an account.", "You handle more than three documents a month and do not want a subscription.", "You want conversions, OCR, compression and media tools alongside PDF editing."],
  ...
  },
  {
    ...
    highlights: ["AI writing tools and a TikTok video downloader, which PrivaTools does not offer.", "Paid plans that list no ads or captchas, against no ads and no paid tier.", "Uploads deleted within an hour on US servers, against cleanup after each response."],
    overview: [
    ...
    sections: [
      ...
      { heading: "How files are handled", body: [
        ...
        "PrivaTools labels each tool before it runs: browser tools keep the input on the device, and server tools write it to temporary per-request storage that is cleaned after the response. It uses Google Analytics by default for page visits, where visits come from, including campaign tags, and each tool run with its outcome and, for failures, a fixed category. Analytics never receives file names or contents, and you can switch it off on the Privacy page.",
      ] },
    ],
    ...
    tradeoffs: ["PrivaTools' free server tools are rate-limited, with heavy jobs capped at five runs a minute from one visitor.", "We did not benchmark output quality for either toolbox."],
    sources: [
  ...
  },
  {
    ...
    description: "ihatepdf.cv runs most PDF tools in the browser but sends text to AI services for chat and summaries; PrivaTools mixes browser and server tools openly.",
    ...
    features: [
      ...
      { label: "Analytics", privatools: "Google Analytics on by default: visits, referrers, campaign tags and tool outcomes, never file names or contents.", competitor: "Microsoft Clarity records how pages are used, with the tool workspace masked.", sourceUrl: "https://www.ihatepdf.cv/about" },
    ],
    sections: [
