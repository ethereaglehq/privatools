...
export const comparisons: ProductComparison[] = [
  {
    ...
    features: [
      ...
      { label: "File types and size", privatools: "JPG, PNG, WebP or BMP; the server engine takes files of up to 500 MB.", competitor: "JPG, PNG or WebP files of up to 22 MB.", sourceUrl: "https://www.remove.bg/help/a/what-image-formats-are-supported" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Files and size", privatools: "Merge takes up to 100 PDFs in one 500 MB upload, which the server then has five minutes to merge; most single-file pages take up to 500 MB.", competitor: "Basic merges 25 files up to 100 MB and Premium 500 files up to 4 GB; Basic Office conversion and OCR take one 15 MB file.", sourceUrl: "https://www.ilovepdf.com/pricing" },
    ...
    sections: [
      { heading: "Reading the Basic plan", body: [
        ...
        "PrivaTools applies the same limits to everyone. An upload request can be 500 MB, and most pages upload each file in a request of its own. Standard tool pages queue up to 25 files, but heavy tools accept about five runs a minute from one visitor, so in a long queue some files are marked failed and need a retry. A page keeps waiting while an upload is moving, however slow, but the server then gives each request five minutes and a PDF to Word conversion 60 seconds, so a very large or complex document can fail. There is no paid tier to lift any of this.",
      ] },
    ...
    tradeoffs: ["iLovePDF showed us its prices in Indian rupees, based on our location, so this page quotes no figure; check the pricing page from where you are.", "PrivaTools' server ends each request five minutes after the upload arrives, so the heaviest jobs on very large files can fail.", "We did not benchmark conversion quality or speed for either product."],
    sources: [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "File size", privatools: "500 MB per upload request, which on most pages holds a single file, and five minutes of server time once it has arrived.", competitor: "The free file size is marked Limited without a number, paid plans Unlimited; AI files up to 50 MB.", sourceUrl: "https://smallpdf.com/pricing" },
    ...
    sections: [
      { heading: "What the free plan leaves out", body: [
        ...
        "PrivaTools does not count use by day. Its strongest compression preset, OCR and PDF to Word are available without an account, but heavy tools accept about five runs a minute from one visitor, so a long batch partly fails and needs retries, and once a file has arrived, OCR has five minutes on the server and PDF to Word 60 seconds. It cannot edit existing PDF text on any plan: Edit PDF adds new content on top of the page.",
      ] },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "File limits", privatools: "Up to 500 MB per file on most pages, 100 PDFs per merge, and five minutes of server time per request.", competitor: "PDFs up to 100 MB; PDF to Word and PowerPoint 200 MB, Split 1 GB, Compress 2 GB; Merge up to 100 files.", sourceUrl: "https://helpx.adobe.com/document-cloud/faq/try-acrobat-online-services.html" },
    ...
    sections: [
      { heading: "Free online tools and their limits", body: [
        ...
        "PrivaTools has no trial logic. Protect PDF, Unlock PDF, compression, conversion, OCR and redaction are free on every run and need no sign-in, within the 500 MB upload cap, a limit of about five runs a minute on heavy tools, and five minutes of server time per request, 60 seconds for a PDF to Word conversion.",
      ] },
    ...
    tradeoffs: ["The online-tool limits here come from an Adobe help article last updated in June 2025, the newest we found.", "A very large file can outlast the five minutes PrivaTools' server gives each request, or the 60 seconds it gives a PDF to Word conversion.", "We did not benchmark either product's output."],
    sources: [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Paid limits", privatools: "The same limits for everyone: 500 MB per request, and a request carries one file on most pages.", competitor: "No page or hourly limits, files up to 500 MB each, OCR up to 100 pages, up to 21 minutes per task.", sourceUrl: "https://www.sejda.com/pricing" },
    ...
    sections: [
      { heading: "How the free limits work", body: [
        ...
        "PrivaTools has no task allowance to spend. Its limits are technical instead: 500 MB per upload request, one file per request on most tool pages, about five runs a minute from one visitor on heavy jobs such as OCR and PDF to Word, and a server time limit that starts once the upload has arrived: five minutes per request, and 60 seconds for a PDF to Word conversion. With nothing to buy, there is also no paid route past those limits on the public site.",
      ] },
    ...
    tradeoffs: ["Its licence agreement says Sejda Desktop contacts Sejda's servers to download OCR language data.", "Long PrivaTools OCR jobs must finish within five minutes on the server, and PDF to Word conversions within 60 seconds; Sejda's paid plans allow up to 21 minutes per task.", "We did not benchmark either product's output."],
    sources: [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Limits", privatools: "Server requests are capped at 500 MB; most tool pages send one file per request.", competitor: "Its tools page says PDF24 has no artificial limits.", sourceUrl: "https://tools.pdf24.org/en/" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Online file limits", privatools: "Up to 500 MB per file on most pages, but a PDF to Word conversion must finish within 60 seconds and OCR within five minutes.", competitor: "The online PDF to Word converter takes files up to 15 MB; Foxit says its desktop version handles higher limits.", sourceUrl: "https://www.foxit.com/pdf-to-word/" },
    ...
    tradeoffs: ["The prices here are Foxit's published US list rates; local prices and taxes can differ.", "PrivaTools' server gives a PDF to Word conversion 60 seconds and an OCR request five minutes, so a long document can fail.", "We did not benchmark editing quality or OCR accuracy."],
    sources: [
  ...
  },
  {
    ...
    category: "Signing & forms",
    highlights: ["10 MB and 100 pages free, 40 MB paid; PrivaTools takes up to 500 MB per file on most pages.", "Files kept in an online account, against temporary processing and local downloads.", "Existing-text editing in PDFescape Desktop on paid plans; PrivaTools only adds content."],
    overview: [
    ...
    features: [
      ...
      { label: "File limits", privatools: "Up to 500 MB per upload request, with one file per request on most pages.", competitor: "Free uploads up to 10 MB and 100 pages; Premium and Ultimate up to 40 MB and 1,000 pages.", sourceUrl: "https://support.pdfescape.com/hc/en-us/articles/360028432531" },
    ...
    tradeoffs: ["PrivaTools' editor and form tools are separate steps, and its signatures are visible images; if you need certificate-based signing, choose a product that issues one.", "Big jobs on PrivaTools can still fail, because its server stops any request that runs longer than five minutes.", "We did not benchmark either editor's output."],
    sources: [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "File limits", privatools: "A 500 MB request cap, which most pages use for one file at a time.", competitor: "Its web-based conversion tools take files up to 100 MB and 500 pages; Table Data Extract takes 25 MB.", sourceUrl: "https://www.gonitro.com/user-guide/workspace/web-based-tools" },
    ...
    tradeoffs: ["Placing a signature image and running a signature-request service are different jobs; compare them separately.", "A long scan can run past the five minutes PrivaTools' server allows an OCR request, and a PDF to Word conversion has only 60 seconds.", "We did not benchmark editing accuracy, OCR quality or speed."],
    sources: [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "File limits", privatools: "500 MB per server request, one file per request on most pages; browser tools depend on your device.", competitor: "No server limit for merging; typically up to 150 MB across all files on a desktop, set by device memory.", sourceUrl: "https://www.ihatepdf.cv/merge-pdf" },
