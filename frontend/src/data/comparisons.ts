...
export const comparisons: ProductComparison[] = [
  {
    ...
    summary: "remove.bg says its standalone website will no longer be available from 1 December 2026 at 9:00am CET: background removal moves to Canva, API access moves to Leonardo.ai and unused pay-as-you-go credits expire that day. Until then it offers free previews up to 0.25 megapixels and paid credits for full resolution. PrivaTools' Background Remover is free at the image's original size, with a server engine or an on-device model.",
    category: "Images & design",
    highlights: ["remove.bg's website and accounts close on 1 December 2026.", "Full resolution costs a credit per image there; PrivaTools is free at full size.", "An on-device engine option, against processing only on remove.bg's servers."],
    overview: [
      "remove.bg removes image backgrounds with AI through its website, an API, desktop apps for Windows, macOS and Linux, an Android app and plugins such as one for Photoshop. A notice across its site says background removal is moving to Canva, and its FAQ says the standalone website, accounts and self-service API end on 1 December 2026 at 9:00am CET, with API access moving to Leonardo.ai, which its API page describes as also part of Canva.",
      "Until that date, previews on the website are free up to 0.25 megapixels for personal use, and each full-resolution image costs one credit, bought in pay-as-you-go packs or a monthly subscription. Uploads can be JPG, PNG or WebP files up to 22 MB and 50 megapixels. Its help centre says the uploaded image and the result are deleted about an hour after upload at the latest, and API images right after the call.",
    ],
    features: [
      ...
      { label: "Use of results", privatools: "The terms leave all rights to your files and outputs with you.", competitor: "Free use and use without an account are for non-commercial purposes only.", sourceUrl: "https://www.remove.bg/help/a/can-i-use-remove-bg-for-commercial-purposes" },
      { label: "File limits", privatools: "JPG, PNG or WebP. The in-browser engine takes images up to 40 megapixels; the server engine takes files of about 250 MB.", competitor: "JPG, PNG or WebP up to 22 MB and 50 megapixels; previews are capped at 0.25 megapixels.", sourceUrl: "https://www.remove.bg/help/a/what-is-the-maximum-image-resolution-file-size" },
      { label: "Where images are processed", privatools: "On PrivaTools' server by default, or in your browser with the downloaded U-2-Net model.", competitor: "On its servers. Its desktop app also sends images to the remove.bg API and needs an internet connection.", sourceUrl: "https://www.remove.bg/a/background-remover-windows-mac-linux" },
      { label: "Retention", privatools: "Temporary files are removed after the response, and a sweep clears leftovers older than ten minutes.", competitor: "Upload and result deleted about an hour after upload at the latest; API images right after the call.", sourceUrl: "https://www.remove.bg/help/a/are-my-images-safe" },
      { label: "Account", privatools: "Not needed for the tool or its batch download.", competitor: "Not needed for website previews; generating an API key requires an account.", sourceUrl: "https://www.remove.bg/help/a/how-do-i-generate-my-api-key" },
      { label: "API", privatools: "Background removal is one of the operations in the free, key-authenticated PrivaTools API.", competitor: "The first 50 API calls a month are free; from 1 December 2026 background removal moves to Leonardo.ai.", sourceUrl: "https://www.remove.bg/api" },
      { label: "What happens next", privatools: "The tool is part of the open-source PrivaTools codebase and can also be self-hosted.", competitor: "Website, accounts, self-service API and plugins end on 1 December 2026; unused pay-as-you-go credits expire.", sourceUrl: "https://www.remove.bg/faq" },
    ],
    sections: [
      { heading: "What 1 December 2026 changes", body: [
        "remove.bg's FAQ sets out the closure. From 1 December 2026 at 9:00am CET the website and accounts will not be accessible, the self-service API stops accepting requests, unused pay-as-you-go credits expire, and the Photoshop plugin and other integrations are discontinued. A subscription ends automatically, and any final renewal on or after 1 November is free. The FAQ says Canva's background remover uses the same technology.",
        "If you still hold credits, download the full-resolution results you need before that date. A workflow built on the remove.bg API or a plugin needs a new home: Leonardo.ai for the API, according to remove.bg, or another tool.",
      ] },
      { heading: "Replacing it with PrivaTools", body: [
        "PrivaTools' Background Remover returns a transparent PNG at the original dimensions, without an account, credits or a personal-use restriction. Its default server engine runs the compact U-2-Net model, u2netp, on the PrivaTools server. The in-browser engine downloads the same model, about 4.4 MB plus its runtime, and then processes images on your device, so they are not uploaded for that path.",
        "remove.bg says its algorithms are trained to handle hard elements such as hair, and it adds background generation and bulk editing. PrivaTools only produces the cut-out, and u2netp is a small model: hair, fur, glass and motion blur can come out rough. We have not compared the two services, so test your hardest images before you move a product catalogue.",
      ] },
    ],
    chooseCompetitor: ["You have remove.bg credits or a subscription to use before 1 December 2026.", "You design in Canva, which is where remove.bg says its background removal is going.", "You need 50-megapixel output, AI-generated backgrounds or its bulk editing before the closure."],
    choosePrivaTools: ["You need transparent PNGs after 1 December 2026 without a Canva account.", "You want full-size cut-outs without buying credits or accepting a non-commercial limit.", "You want the choice to keep images on your device with the in-browser engine.", "You want background removal through a free API key you can call from your own scripts."],
    tradeoffs: ["remove.bg's help centre says uploads are not used to train its AI, while its privacy policy says account content may be analysed to train its models; read both if that matters to you.", "PrivaTools' model is compact, which suits quick cut-outs; inspect edges on dark and light backgrounds before relying on a result.", "Neither service's output quality was benchmarked for this page."],
    sources: [
      ...
      { label: "remove.bg API", url: "https://www.remove.bg/api" },
  ...
  },
  {
    ...
    description: "iLovePDF's free Basic plan caps files per task and size, and Premium adds desktop and mobile apps. PrivaTools is free with open code. Limits compared.",
    summary: "iLovePDF is a broad PDF suite on the web, Windows, macOS, iOS and Android. Its free Basic plan works without an account but limits files per task and file size, and Premium unlocks the desktop and mobile apps, workflows, digital signatures and much larger files. PrivaTools has no paid plan, adds image, media and developer tools and publishes its code, but it has no native apps.",
    category: "Everyday PDF",
    highlights: ["Free merging: 25 files and 100 MB on iLovePDF Basic, 100 files and 500 MB on PrivaTools.", "Desktop and mobile apps come with Premium; PrivaTools runs in the browser.", "Files deleted within two hours there, against cleanup after each response."],
    overview: [
      "iLovePDF, from ILOVEPDF S.L. in Barcelona, offers PDF tools on the web, desktop apps for Windows and macOS, iOS and Android apps and a Chrome extension. Its free Basic plan covers the essential tools with limited processing and needs no account, although its AI tools require one. Premium, for up to 25 users, adds every tool, unlimited processing, desktop and mobile access, workflows, digital signatures, an ad-free experience and 2,000 AI credits a month.",
      "Files uploaded to the web service are processed on iLovePDF's servers and deleted automatically within two hours. Premium and Business users can choose the region where files are processed, and the desktop app processes files on your computer. Its developer product, iLoveAPI, offers PDF, image and signature tools as a REST API with a monthly allowance of free credits.",
    ],
    features: [
      ...
      { label: "Free-plan limits", privatools: "No task quota on the website; heavy jobs such as OCR allow five runs a minute per IP.", competitor: "Basic processes a limited number of documents, and tools such as OCR to Word and PDF/A are Premium only.", sourceUrl: "https://www.ilovepdf.com/pricing" },
      { label: "Files and size", privatools: "Merge takes up to 100 PDFs in one 500 MB request; most single-file pages take about 250 MB.", competitor: "Basic merges 25 files up to 100 MB; Office conversion and OCR take one 15 MB file; Premium goes to 4 GB.", sourceUrl: "https://www.ilovepdf.com/pricing" },
      { label: "Where files are processed", privatools: "Most PDF tools run on the PrivaTools server in temporary per-request storage; text and developer tools run in your browser.", competitor: "On its servers; Premium and Business users can choose the region where files are processed.", sourceUrl: "https://www.ilovepdf.com/pricing" },
      { label: "Retention", privatools: "Response cleanup removes each job's files; a sweep clears leftovers after ten minutes.", competitor: "Files are deleted automatically within two hours of processing on its servers.", sourceUrl: "https://www.ilovepdf.com/help/terms" },
      ...
      { label: "API", privatools: "A free key with a default daily allowance of 500 processing units.", competitor: "iLoveAPI gives 2,500 free credits a month on registration, with paid credit plans in US dollars.", sourceUrl: "https://www.iloveapi.com/pricing" },
    ],
    sections: [
      { heading: "Reading the Basic plan", body: [
        "iLovePDF sets its free limits per tool rather than per day. On Basic, merging takes up to 25 files and 100 MB, compression takes two files up to 200 MB, and Office conversion and OCR take one file of 15 MB, while editing and splitting take one file on every plan. Some tools, including OCR conversion to Word or Excel and PDF/A, are marked as not included in Basic. The pricing table is not fully consistent: it lists Basic limits for a few tools it also marks as Premium only.",
        "PrivaTools uses one set of limits for everyone: 500 MB per upload request, about 250 MB per file on most single-file pages, up to 25 files queued on a standard tool page, and up to 100 PDFs in one merge. There is no Premium to lift them on the public site, although a self-hosted copy can raise the request cap.",
      ] },
      { heading: "Apps, regions and signatures", body: [
        "Premium includes iLovePDF's desktop apps, which process files on your computer, and its mobile apps. Premium users can pick among seven processing regions and Business users among eleven. Its signature tool embeds a certified hash and qualified timestamp, and its security page says signed documents are kept for up to five years to meet legal requirements.",
        "PrivaTools has no native apps and no region choice on the public site; if location or offline processing matters, you can run it on your own hardware. Its Sign PDF and E-Sign PDF place a visible signature image and do not create certificate-based or certified signatures.",
      ] },
    ],
    chooseCompetitor: ["You want native desktop and mobile apps under one PDF subscription.", "You send documents for signature and want its certified signatures with a qualified timestamp.", "You need files processed in a specific region, or files far larger than PrivaTools accepts.", "Your files live in Google Drive or Dropbox, which it integrates with."],
    choosePrivaTools: ["You want free use without per-tool file-count tiers or a sign-up.", "You want source code you can inspect and a copy you can host.", "You also work with images, audio, video, archives or developer formats."],
    tradeoffs: ["iLovePDF showed us its prices in Indian rupees, based on our location, so this page quotes no figure; check the pricing page from where you are.", "Its security page and business page cite different versions of its ISO 27001 certification; check the current certificate if procurement depends on it.", "We did not benchmark conversion quality or speed for either product."],
    sources: [
  ...
  },
  {
    ...
    summary: "Smallpdf offers PDF tools on the web, free iOS and Android apps with more for Pro users, a Windows desktop app and a Chrome extension and apps for Google Workspace and Dropbox. Its free plan works without signing up for most tools but limits downloads, compression strength and AI use; Pro lifts those limits and includes Sign.com e-signatures, and first-time subscribers can take a 7-day trial that asks for payment details. PrivaTools is free throughout and open source, with no native apps.",
    category: "Everyday PDF",
    highlights: ["Daily download limits on Smallpdf's free plan, against no task quota.", "Pro includes Sign.com signature requests; PrivaTools places signature images only.", "Processing on EU servers, against temporary processing you can also self-host."],
    overview: [
      "Smallpdf's pricing page lists Free, Pro, Team and Business plans. The free plan offers limited document downloads, limited mobile app access and a Sign.com account limited to two documents a month; Pro adds unlimited downloads, text editing, OCR, strong compression, unlimited AI tools and unlimited mobile access. Its Windows desktop app handles files offline, and its macOS app has not been supported since October 2021.",
      "Uploaded files are processed on Hetzner servers in the European Union. With a user account, files are deleted within one hour unless you save them to your storage; the support page says files are removed an hour after processing for most tools. AI features use OpenAI, and Smallpdf says it does not share your content with OpenAI for training. It states that it is ISO/IEC 27001 certified.",
    ],
    features: [
      ...
      { label: "Free-plan limits", privatools: "No daily allowance; heavy jobs allow five runs a minute per IP.", competitor: "Most tools carry a daily download limit; AI tools allow up to 4 documents a day.", sourceUrl: "https://smallpdf.com/pricing" },
      { label: "File size", privatools: "500 MB per upload request; about 250 MB per file on most single-file pages.", competitor: "The free file size is marked Limited without a number, paid plans Unlimited; AI files up to 50 MB.", sourceUrl: "https://smallpdf.com/pricing" },
      { label: "Where files are processed", privatools: "In your browser or in PrivaTools' temporary server storage, as each tool states.", competitor: "On Hetzner servers in the European Union.", sourceUrl: "https://smallpdf.com/privacy" },
      ...
      { label: "Platforms", privatools: "Browser on any operating system; installable as a web app.", competitor: "Web and a Windows desktop app that works offline; its macOS app is marked unsupported.", sourceUrl: "https://smallpdf.com/download" },
      { label: "Signatures", privatools: "Sign PDF and E-Sign PDF place a drawn, typed or uploaded signature image.", competitor: "Sign.com can request signatures, track activity, add digital seals and issue a certificate of completion.", sourceUrl: "https://smallpdf.com/sign-pdf" },
    ],
    sections: [
      { heading: "What the free plan leaves out", body: [
        "Smallpdf meters its free plan by day. Most tools carry a daily download limit, the mobile apps a daily task limit, and strong compression, batch processing, OCR to Office formats, text editing and image extraction are Pro features. The support page mentions two conversions a day, while the pricing page gives no single daily number.",
        "PrivaTools does not meter use by day. Its Extreme compression preset, batch queues of up to 25 files, OCR and PDF to Word are all available without an account, within the request size limit and per-IP rate limits on heavy jobs. It has no mode for editing existing PDF text, paid or free: Edit PDF adds new content on top of the page.",
      ] },
      { heading: "Signing and AI", body: [
        "Pro bundles Sign.com, so one subscription covers editing and signature requests with tracking and a certificate of completion. Smallpdf's AI tools, including chat with PDF, summaries and translation, are part of its plans. PrivaTools' AI tools need either an on-device model download or your own provider key, and its signature tools place an image rather than running a signing workflow.",
    ...
    choosePrivaTools: ["You need more than a few downloads a day without paying.", "You want strong compression, OCR or batch runs without a subscription.", "You prefer open code, or to host the service yourself."],
    tradeoffs: ["Smallpdf's own pages give different figures for its tool count, yearly discount and team size; rely on the pricing page for the plan you choose.", "Its privacy notice describes different deletion rules with and without an account; check which applies before uploading sensitive files.", "We did not benchmark output quality or speed."],
    sources: [
      ...
      { label: "Smallpdf terms", url: "https://smallpdf.com/terms" },
    ],
  ...
  },
  {
    ...
    description: "Adobe Acrobat's free online tools allow one task without signing in, and text editing needs a paid plan; PrivaTools is free with no account. Plans compared.",
    summary: "Adobe Acrobat spans free Acrobat Reader, free online tools with trial limits, and paid Standard, Pro and Studio plans that add editing of existing text, signature requests, redaction, comparison and AI. PrivaTools is free and needs no account for any tool, and covers media and developer tasks too, but it cannot edit existing PDF text or run signature workflows, and it has no desktop app.",
    category: "Desktop & teams",
    highlights: ["One free online task without signing in, against no task quota and no sign-in.", "Existing-text editing on paid plans, which PrivaTools does not offer.", "Certificate signatures and signature requests, against image signatures only."],
    overview: [
      "Adobe Acrobat comes as free Acrobat Reader, free online tools and subscription plans: Acrobat Express, Standard, Pro and Studio, each with a team version. Editing text and images requires Standard or Pro, not Reader. Standard adds signature requests with tracking; Pro adds version comparison, redaction, bulk e-signature requests and OCR; Studio includes everything in Pro plus PDF Spaces, AI Assistant for Acrobat and Adobe Express Premium.",
      "Acrobat's online services upload files to Adobe cloud storage and protect them with AES-256 encryption and TLS 1.2. Without signing in, most online tools allow one free task and one download, and Adobe deletes the file from its servers soon afterwards. The desktop apps run on Windows and macOS, and Adobe says it does not use your documents or data to train AI models.",
    ],
    features: [
      { label: "Price", privatools: "Free, with no subscription, trial or licence.", competitor: "In the US: Standard US$14.99, Pro US$19.99 and Studio US$24.99 a month on an annual plan billed monthly.", sourceUrl: "https://www.adobe.com/acrobat/pricing.html" },
      { label: "Free online limits", privatools: "No task quota; heavy jobs allow five runs a minute per IP.", competitor: "Without signing in, most tools allow one free task and one download; signed-in users get a premium task every 30 days.", sourceUrl: "https://helpx.adobe.com/document-cloud/faq/try-acrobat-online-services.html" },
      { label: "File limits", privatools: "500 MB per request, Merge up to 100 PDFs, about 250 MB per file on most pages.", competitor: "Online tools take PDFs up to 100 MB, PDF to Word and PowerPoint 200 MB and Compress 2 GB; Merge takes 100 files.", sourceUrl: "https://helpx.adobe.com/document-cloud/faq/try-acrobat-online-services.html" },
      { label: "Where files are processed", privatools: "No cloud library: server tools work on temporary copies, and browser-only tools process on your device.", competitor: "Online tools upload to Adobe cloud storage, in data centres in North America, EMEA and Japan.", sourceUrl: "https://helpx.adobe.com/acrobat/web/manage-cloud-storage/manage-adobe-cloud-files/cloud-storage-data-centers.html" },
      ...
      { label: "Editing existing text", privatools: "Not available: Edit PDF adds text, drawings, images and whiteout on top of the page.", competitor: "Needs a Standard or Pro subscription; Acrobat Reader cannot edit text or images.", sourceUrl: "https://www.adobe.com/acrobat/pdf-reader.html" },
      ...
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "Licensed, not sold; the terms forbid attempts to discover the source code.", sourceUrl: "https://www.adobe.com/legal/terms.html" },
      { label: "Platforms", privatools: "Any modern browser, including on Linux; installable as a web app.", competitor: "Desktop apps for 64-bit Windows 10 and 11 and for macOS 13 or later.", sourceUrl: "https://helpx.adobe.com/acrobat/desktop/get-started/learn-the-basics/tech-requirements.html" },
    ],
    sections: [
      { heading: "Free tools or a subscription", body: [
        "Adobe's free online tools work as a trial of the paid product. Without an Adobe ID, most tools allow one task and one download; with one, you can share, fill, sign and comment on PDFs free, and try premium tools once every 30 days. Removing a password needs a subscription or the seven-day Acrobat Pro trial, and Adobe notes that a password added with the free Protect PDF tool cannot then be removed with it. Page tools such as rotate and extract handle up to 1,500 pages.",
        "PrivaTools has no trial logic. Protect PDF, Unlock PDF, compression, conversion, OCR and redaction are free on every run, within the request size and rate limits, and nothing requires signing in.",
      ] },
      { heading: "Where Acrobat does more", body: [
        "Acrobat edits existing text and images and adjusts the formatting, compares versions, creates web forms and reusable e-sign templates, repairs accessibility tagging in Pro and saves PDF/A, PDF/X and PDF/E files in Pro. It signs with certificates and validates signed files, and Standard and above request signatures and track responses. Its AI Assistant, included in Studio or added to other plans, processes documents in Adobe's cloud with Microsoft Azure OpenAI.",
        "PrivaTools covers parts of this with separate free tools: Compare PDF shows visual or text differences, Form Creator adds fillable fields, the Accessibility Checker audits tagging without changing the file, Redact PDF removes the content under each box, and Verify Digital Signature checks whether each signature still matches the file, without checking the certificate against a trust list. It has no text editing and no certificate signing, and its AI tools use on-device models or your own provider key.",
      ] },
    ],
    chooseCompetitor: ["You edit existing text and images in PDFs as part of daily work.", "You need certificate-based signatures, or signature requests with tracking.", "You produce PDF/A files or repair accessibility tagging with Acrobat Pro.", "Your team needs licences managed centrally across desktop, web and mobile."],
    choosePrivaTools: ["You need a task done in a browser without an Adobe ID or a trial.", "You protect, unlock, compress, convert, OCR or redact files often and want that free.", "You want open code you can host yourself, on any operating system."],
    tradeoffs: ["Adobe's pages list plans and AI add-ons differently: the US pricing page shows Acrobat Express and a US$1.99 AI Assistant add-on, while the trial page offers AI Assistant Plus at US$4.99. Check the plan page for your country.", "The online-tool limits here come from an Adobe help article last updated in June 2025, the newest we found.", "We did not benchmark either product's output."],
    sources: [
      { label: "Adobe Acrobat plans and pricing (US)", url: "https://www.adobe.com/acrobat/pricing.html" },
      ...
      { label: "Adobe cloud storage data centres", url: "https://helpx.adobe.com/acrobat/web/manage-cloud-storage/manage-adobe-cloud-files/cloud-storage-data-centers.html" },
      { label: "Adobe General Terms of Use", url: "https://www.adobe.com/legal/terms.html" },
      { label: "Acrobat Pro free trial", url: "https://www.adobe.com/acrobat/free-trial-download.html" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Free-use limits", privatools: "No hourly or daily task allowance; heavy jobs allow five runs a minute per IP.", competitor: "Most free web tools: documents up to 200 pages or 50 MB, and 3 tasks per hour.", sourceUrl: "https://www.sejda.com/pdf-editor" },
      ...
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "The Desktop licence agreement says the software is not open source.", sourceUrl: "https://www.sejda.com/eula" },
    ...
    sections: [
      { heading: "How the free limits work", body: [
        "Sejda's free web tier suits occasional jobs but counts them. Most tools accept documents up to 200 pages or 50 MB, compress and deskew allow 100 MB, OCR and split by text stop at 10 pages, and every tool shares a limit of three tasks per hour. The free Desktop tier allows three tasks per day. A Week Pass lifts the web limits for seven days as a one-time charge that does not renew. Prices are in US dollars, with tax calculated at checkout.",
        "PrivaTools has no task allowance to spend. Its limits are technical instead: 500 MB per upload request, about 250 MB per file on most tool pages, and per-IP rate limits on heavy jobs such as OCR and conversions. With nothing to buy, there is also no paid route past those limits on the public site.",
      ] },
      { heading: "Editing, splitting and scans", body: [
        "If you need to change words that are already in a PDF, Sejda lists existing-text editing; PrivaTools' Edit PDF places new text, shapes, images and whiteout on top of the page instead. Both split by bookmarks, by size and by text, and both straighten skewed scans and run OCR. Sejda also lists workflows, Bates numbering and a form tool that detects fields in a static PDF; PrivaTools has Bates numbering, a pipeline that chains PDF steps and a form creator where you place the fields yourself.",
      ] },
    ],
    ...
    tradeoffs: ["Sejda's pages differ on retention: tool pages say two hours, while the home page and privacy policy say files are deleted after processing without giving a period.", "Its licence agreement says Sejda Desktop contacts Sejda's servers to download OCR language data.", "We did not benchmark either product's output."],
    sources: [
      ...
      { label: "Sejda privacy policy", url: "https://www.sejda.com/privacy" },
    ],
  ...
  },
  {
    ...
    overview: [
      "PDF24, from Geek Software GmbH, offers PDF24 Online Tools in the browser and PDF24 Creator, an application for Windows. Its FAQ says the tools are free for everyone, including companies, and are financed by discreet advertising on its websites. Its terms allow commercial use when document processing is not itself the core of your business, rule out automated scripts, and note that free provision is not guaranteed in future.",
    ...
    features: [
      ...
      { label: "Terms of use", privatools: "Fair-use rate limits; the terms allow reasonable API use with a free key.", competitor: "Commercial use only if processing documents is not your core business; no automated scripts.", sourceUrl: "https://www.pdf24.org/en/terms-of-use" },
      ...
      { label: "Platforms", privatools: "Any modern browser; installable as a web app.", competitor: "Online tools in any browser; Creator for Windows 10 and 11 only, also in the Microsoft Store.", sourceUrl: "https://tools.pdf24.org/en/creator" },
    ],
    sections: [
    ...
    tradeoffs: ["PDF24's FAQ places its servers in EU data centres, while its merge page says they are in Germany; both describe the same online tools.", "Its Creator manual documents a setting that stops Creator using the online converter when no local converter is available; check it if files must stay on the PC.", "We did not benchmark output quality for either product."],
    sources: [
      { label: "PDF24 FAQ", url: "https://tools.pdf24.org/en/faq" },
      { label: "PDF24 Creator", url: "https://tools.pdf24.org/en/creator" },
      { label: "PDF24 terms of use", url: "https://www.pdf24.org/en/terms-of-use" },
  ...
  },
  {
    ...
    summary: "Foxit sells PDF Editor and PDF Editor+ subscriptions and a perpetual licence, with desktop apps for Windows and macOS, a web version and, on Editor+, mobile apps. It edits existing text with reflow, runs OCR, compares versions and handles certificate signatures, and every Foxit account gets monthly AI credits. PrivaTools is free and needs no account, but it does not edit existing text or collect signatures, and it has no desktop app.",
    category: "Desktop & teams",
    highlights: ["Paid editing from $129.99 a year or a $209.99 perpetual licence, against free.", "On-device Local AI in Foxit's desktop apps; PrivaTools runs its models in the browser.", "Signature requests on PDF Editor+, which PrivaTools does not offer."],
    overview: [
    ...
    features: [
      ...
      { label: "Online file limits", privatools: "500 MB per request; about 250 MB per file on most pages.", competitor: "The online PDF to Word converter takes files up to 15 MB.", sourceUrl: "https://www.foxit.com/pdf-to-word/" },
      ...
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "Licensed, not sold; the EULA calls its source code a trade secret.", sourceUrl: "https://www.foxit.com/pdf-editor/eula/" },
      ...
      { label: "AI", privatools: "On-device models for summaries, translation and transcription, or your own provider key.", competitor: "300 AI credits a month with any Foxit account, and Local AI that runs on the device in its desktop apps.", sourceUrl: "https://www.foxit.com/ai/" },
    ...
    sections: [
      ...
      { heading: "Online tools and AI", body: [
        "Foxit's free online converters run on its servers, and each sets its own size cap: PDF to Word and OCR take 15 MB, merging 20 MB per file and compression 150 MB. Its cloud AI features run on Microsoft Azure, with extracted data deleted within 24 hours, while Local AI in the desktop apps works without an internet connection.",
        "PrivaTools' AI either runs in your browser with downloaded models, for summaries, translation, transcription and detecting personal data, or goes from your browser to a provider you choose, with your own key. There are no credits to buy.",
      ] },
    ],
    ...
    choosePrivaTools: ["You need occasional PDF tasks without a licence, trial or account.", "Your files are larger than Foxit's free online converters accept.", "You want image, audio, video and developer tools, and code you can host."],
    tradeoffs: ["Foxit describes its AI limits in two ways, as credits on its pricing and AI pages and as prompts and pages on its cloud page; check the current terms for your plan.", "The prices here are Foxit's published US list rates; local prices and taxes can differ.", "We did not benchmark editing quality or OCR accuracy."],
    sources: [
      ...
      { label: "Foxit PDF Editor Cloud", url: "https://www.foxit.com/pdf-editor/cloud/" },
    ],
  ...
  },
  {
    ...
    description: "LightPDF pairs PDF tools with AI features paid for in credits and asks free users to sign up; PrivaTools uses your own AI key or on-device models.",
    summary: "LightPDF combines PDF editing and conversion with AI features, including an AI agent, document chat and a document generator, across the web, Windows, Mac, Android and iOS. Its free web plan requires sign-up and caps files at 10 MB and AI use at a few requests a day; paid plans include monthly AI credits. PrivaTools needs no account and brings AI through on-device models or your own provider key.",
    category: "Document AI",
    highlights: ["AI paid for in credits, against your own provider key or on-device models.", "A free plan that needs sign-up and caps files at 10 MB, against no account.", "Apps for Windows, Mac and mobile, against a browser app."],
    overview: [
      ...
      "Payment terms that took effect in January 2026 introduced credits, which pay for conversion tools and AI features. Monthly and yearly plans include 1,000 credits a month that expire, and a lifetime plan includes 40,000. The free plan is web only and requires sign-up, and LightPDF's licence agreement describes its software as a proprietary product.",
    ],
    features: [
      ...
      { label: "Free-plan limits", privatools: "No account or daily quota; heavy jobs allow five runs a minute per IP.", competitor: "Files up to 10 MB; AI agent 3 questions a day; ChatPDF 1 file a day; no batch processing.", sourceUrl: "https://lightpdf.com/pricing" },
      { label: "AI", privatools: "Your own key for Anthropic, OpenAI, Gemini, Mistral, DeepSeek, Together AI or a local server, or on-device models.", competitor: "AI agent, ChatPDF, translation and a document generator, paid for in credits: 1,000 a month on paid plans.", sourceUrl: "https://lightpdf.com/pricing" },
      { label: "Where files are processed", privatools: "Chat with PDF extracts text in your browser; PDF conversions run on PrivaTools' server in temporary storage.", competitor: "Web tools process files on its servers, where they are stored temporarily and deleted regularly.", sourceUrl: "https://lightpdf.com/help-documentation.html" },
      ...
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "Its licence agreement calls the software a proprietary product of LightPDF.", sourceUrl: "https://lightpdf.com/license-agreement" },
    ...
    sections: [
      { heading: "AI in the plan or on your own key", body: [
        "LightPDF includes AI in its plans and meters it in credits: the pricing page lists 20 credits for an AI chat and 5 credits a page for translation, with extra credits for sale. Free users get three AI agent questions a day and one ChatPDF file a day, up to 100 pages. It says your data and chat contents are not used to train AI models.",
      ...
      { heading: "Where documents are kept", body: [
        "LightPDF's pages describe retention differently by tool. Its help guide says processed files are stored temporarily and deleted regularly, the editor page gives 24 hours, the merge page says files are deleted after the changes are done, and ChatPDF keeps documents in encrypted cloud storage until you delete them. The free plan includes cloud storage of five files for a year.",
        "PrivaTools has no cloud storage. Server tools write inputs and results to temporary per-request files that are removed after the response, with a background sweep for leftovers older than ten minutes; the copies that remain are the ones you download.",
      ] },
    ],
    ...
    tradeoffs: ["LightPDF's refund terms differ between its pricing page and its payment terms; read both before buying.", "PrivaTools' Chat with PDF needs your own provider key, and that provider's terms and charges apply.", "AI answers from either product need checking against the document; we did not test their accuracy."],
    sources: [
  ...
  },
  {
    ...
    description: "Stirling PDF is an open-core PDF editor with desktop apps and paid Team plans; PrivaTools is an MIT-licensed web toolbox. Plans, licences and hosting compared.",
    summary: "Both can run on your own server. Stirling PDF is a PDF-focused editor that also ships desktop apps for Windows, macOS and Linux, and sells Team and Enterprise licences for larger self-hosted installations. PrivaTools covers PDFs plus images, audio, video and developer utilities in one web app under the MIT licence, with no paid tier.",
    category: "Local & self-hosted",
    highlights: ["Open-core licensing with paid tiers, against MIT with no paid tier.", "Desktop apps with a local mode, against a browser app you install as a PWA.", "Single sign-on and audit logs on paid plans, which PrivaTools does not offer."],
    overview: [
      "Stirling PDF describes itself as open-core: its repository is MIT-licensed except for listed directories that carry a proprietary Stirling PDF User License, and production use of that proprietary code needs a valid licence. It offers desktop apps for Windows, macOS and Linux, self-hosting with Docker, Kubernetes or a Java .jar, and a hosted version at stirling.com/app.",
      "Its pricing page lists a Free plan at $0 a month, a Team plan at $99 a month with 100 users included, an Enterprise plan on custom terms, and a PDF Processor billed at 1 cent per credit. Its documentation adds that a Team licence covers one installation, and that the licence tier decides which features, such as single sign-on, SAML and audit logs, are unlocked.",
    ],
    features: [
      ...
      { label: "Free tier", privatools: "The MIT licence sets no user or seat limit, on the public site or your own server.", competitor: "The free self-hosted tier covers up to 5 users; more need a Team or Enterprise plan.", sourceUrl: "https://docs.stirlingpdf.com/Modes%20and%20Licensing/" },
      { label: "File size", privatools: "The public site takes 500 MB per request; a self-hosted copy can change the cap.", competitor: "A self-hosted install has no upload limit by default; administrators can set one.", sourceUrl: "https://github.com/Stirling-Tools/Stirling-PDF/blob/main/app/core/src/main/resources/settings.yml.template" },
      { label: "Where files are processed", privatools: "In your browser for browser-only tools, otherwise on privatools.me or your own server.", competitor: "Desktop local mode runs basic tools on the device; OCR, conversion, compression and repair need a server or its cloud.", sourceUrl: "https://docs.stirlingpdf.com/Modes%20and%20Licensing/" },
      { label: "Account", privatools: "Not needed on the public site; a self-hosted copy can use Clerk, local accounts or no accounts at all.", competitor: "The desktop app needs no login; the Docker image turns login on by default, and you can switch it off.", sourceUrl: "https://docs.stirlingpdf.com/Installation/Docker%20Install/" },
      { label: "Source code", privatools: "MIT licence for the whole repository.", competitor: "Open-core: MIT outside listed directories, which carry a proprietary licence.", sourceUrl: "https://github.com/Stirling-Tools/Stirling-PDF/blob/main/LICENSE" },
      ...
      { label: "Team administration", privatools: "Optional accounts issue API keys; there are no roles, SSO or audit logs.", competitor: "OAuth2 single sign-on on Team; SAML sign-in and audit logs on Enterprise.", sourceUrl: "https://docs.stirlingpdf.com/Paid-Offerings/" },
    ],
    sections: [
      { heading: "Licences and what you pay for", body: [
        "Stirling PDF's free tier suits individuals and small groups: its documentation limits free self-hosted installations to five users and says a Team licence, at $99 a month, covers one installation with 100 users. Enterprise adds SAML sign-in, audit logs, SCIM provisioning and air-gapped deployment. Because proprietary directories sit inside an otherwise MIT repository, check which features your deployment uses before assuming all of it is freely licensed.",
        "PrivaTools has no licence tiers. The same MIT-licensed code runs the public site and any copy you host, and nothing is unlocked by payment. The trade-off is that PrivaTools has no organisation features: accounts exist to issue developer API keys, not to manage teams.",
      ] },
      { heading: "Running it yourself", body: [
        "Stirling documents Docker, Kubernetes with Helm, bare-metal .jar installs and managed desktop fleets, where IT pre-configures desktop installs through device-management tools. Its automation includes a REST API, pipelines, folder scanning and an MCP server for AI assistants, and its 2.14 desktop release added signing with USB tokens and smart cards. PrivaTools ships as a Docker Compose project whose heavy tools rely on bundled engines such as LibreOffice, Tesseract and FFmpeg, so plan for their CPU and memory use.",
    ...
    chooseCompetitor: ["You want a PDF editor that also runs as a desktop app on Windows, macOS or Linux.", "Your organisation needs single sign-on, audit logs or user management and can budget for a licence.", "You want to automate PDF work with its pipelines, folder scanning or REST API on your own server.", "You need certificate signing from a USB token or smart card on the desktop."],
    choosePrivaTools: ["You want every feature under one permissive licence, with no seat count to track.", "Your work mixes PDFs with images, audio, video, archives and developer utilities.", "You want AI features that run on your device or with your own provider key.", "You would like to try a public site first and self-host later with the same tools."],
    tradeoffs: ["Stirling's pages differ on some details: its pricing page shows no user cap on the Free plan, while its documentation sets five users. Check the licensing documentation for your case.", "Self-hosting either product makes you responsible for updates, backups, logs and capacity, and for how the copy you run handles files.", "We did not benchmark conversion quality, OCR accuracy or speed for either product."],
    sources: [
      ...
      { label: "Stirling PDF modes and licensing", url: "https://docs.stirlingpdf.com/Modes%20and%20Licensing/" },
      ...
      { label: "Stirling PDF settings template", url: "https://github.com/Stirling-Tools/Stirling-PDF/blob/main/app/core/src/main/resources/settings.yml.template" },
  ...
  },
  {
    ...
    description: "DocHub is an online editor built for signing and forms, with three free uses a month; PrivaTools is free without an account but has no sign requests.",
    summary: "DocHub is a web editor built around signing: sign requests, envelopes, templates and an audit trail, with iOS and Android apps and Google Workspace integrations. Its free plan shares three uses a month across core features, and some downloads need a free account; Basic and Pro raise the limits. PrivaTools needs no account and has form and signature tools, but no sign requests, audit trail or document storage.",
    category: "Signing & forms",
    highlights: ["Signature requests and audit trails, which PrivaTools does not offer.", "Three core-feature uses a month on DocHub's free plan, against no quota.", "Documents stored on AWS in the United States, against temporary processing."],
    overview: [
      "DocHub is an online PDF editor and e-signature service listed among airSlate's products. It lets you edit and annotate PDFs, build reusable templates and fillable fields, send sign requests and envelopes, and keep an audit trail; its legal page says its e-signatures comply with the US ESIGN Act and UETA. It needs no installation and integrates with Google Drive, Gmail, OneDrive, Dropbox and Microsoft 365.",
      "The pricing page lists a Free plan, Basic, Pro and a Site License for enterprises. Documents are stored in encrypted AWS S3 storage, and its privacy notice says the service depends on data transfers to the United States. Its help centre says uploaded files must be under 30 MB and fewer than 1,000 pages.",
    ],
    features: [
      ...
      { label: "Free-plan limits", privatools: "No monthly allowance on the website.", competitor: "Core features, including text editing, self-signing, sign requests and templates, share 3 uses a month.", sourceUrl: "https://dochub.com/pricing" },
      { label: "File size", privatools: "500 MB per upload request, about 250 MB per file on most pages.", competitor: "Files under 30 MB and fewer than 1,000 pages.", sourceUrl: "https://help.dochub.com/knowledge-base/creating-importing-downloading-and-exporting-documents/uploading-documents-and-pdfs-to-dochub" },
      { label: "Where documents are kept", privatools: "No document storage; server tools use temporary per-request files.", competitor: "Stored on Amazon Web Services and encrypted at rest.", sourceUrl: "https://dochub.com/site/security" },
      { label: "Account", privatools: "Not needed for any tool.", competitor: "A free account is needed to download results from its merge and split tools.", sourceUrl: "https://merge-pdf.dochub.com" },
      { label: "Licence", privatools: "MIT-licensed code you can self-host.", competitor: "Its terms grant a limited, non-exclusive licence to use the service.", sourceUrl: "https://legal.dochub.com/terms" },
    ...
    sections: [
      { heading: "Signing with other people", body: [
        ...
        "PrivaTools stops at your own signature. Sign PDF and E-Sign PDF place a drawn, typed or uploaded signature image on a page, Form Creator adds fillable fields including signature fields, and Fill Form completes existing fields. There is no way to send a document for signature, track it or produce a certificate of completion.",
      ] },
      { heading: "The free plan in practice", body: [
        "DocHub's free plan fits a few documents a month: its core features share a limit of three uses a month, and Basic keeps that cap on selected Pro features while adding unlimited downloads, self-signing and templates. The pricing page and the AI feature page disagree about whether its AI Assistant is included for free.",
        "PrivaTools has no monthly allowance. Each tool is limited only by request size, per-IP rate limits on heavy jobs and, for browser-only tools, your device. It also has no account to keep documents in, so download a completed form before you leave the page.",
      ] },
    ],
    ...
    choosePrivaTools: ["You need to fill, sign or annotate a PDF now without creating an account.", "You handle more than three documents a month and do not want a subscription.", "You want conversions, OCR, compression and media tools alongside PDF editing."],
    tradeoffs: ["A visible signature image and a tracked signature request are different things; if you need proof of who signed and when, PrivaTools is not the right tool.", "DocHub's pricing page lists some features differently from its own feature pages; check the plan before relying on a feature.", "We did not benchmark either editor."],
    sources: [
  ...
  },
  {
    ...
    summary: "PDFescape is a long-running online PDF editor and form filler with a free tier, paid Premium and Ultimate plans, and a Windows desktop app. It suits annotating, filling and building simple forms, and keeps your files in an online list for days or weeks. PrivaTools has no paid tier and keeps no documents between visits; it runs each tool in the browser or on a temporary server, and adds conversions, OCR and media tools.",
    category: "Signing & forms",
    highlights: ["10 MB and 100 pages on the free plan, against up to 500 MB per upload request.", "Files kept in an online account, against temporary processing and local downloads.", "Existing-text editing in paid plans; PrivaTools adds content without editing text."],
    overview: [
      "PDFescape, from Avanquest Software, offers PDFescape Online, an editor and form filler that runs in the web browser, and PDFescape Desktop for Windows. The free online tier needs no registration and lets you annotate, fill in forms and add new form fields. Premium and Ultimate subscriptions raise the limits, remove ads and add editing of existing text and images; Ultimate adds advanced forms, digital signing and redaction.",
      "Documents opened in PDFescape Online are uploaded and saved on its web servers, which it says are in a United States data centre. Free users keep up to 10 stored files for 7 days, Premium users 100 files for 30 days, and Ultimate users 100 files with no expiry. Its terms say the software is licensed, not sold.",
    ],
    features: [
      { label: "Price", privatools: "Free, with no plans to upgrade to.", competitor: "Free online tier with ads; Premium $2.99 a month billed yearly or $5.99 monthly; Ultimate $5.99 yearly or $8.99 monthly.", sourceUrl: "https://www.pdfescape.com/signup/" },
      { label: "File limits", privatools: "500 MB per upload request; about 250 MB per file on most pages.", competitor: "Free uploads up to 10 MB and 100 pages; Premium and Ultimate up to 40 MB and 1,000 pages.", sourceUrl: "https://support.pdfescape.com/hc/en-us/articles/360028432531" },
      { label: "Stored files", privatools: "No document storage; each result downloads to your device.", competitor: "Free: 10 files kept 7 days; Premium: 100 files for 30 days; Ultimate: 100 files with no expiry.", sourceUrl: "https://www.pdfescape.com/what/premium/" },
      ...
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "Licensed, not sold; Avanquest keeps the rights to the software.", sourceUrl: "https://www.pdfescape.com/terms/" },
      ...
      { label: "Editing existing text", privatools: "Not available: Edit PDF adds text, drawings, images and whiteout on top.", competitor: "Editing existing text and images is a Premium and Ultimate feature.", sourceUrl: "https://www.pdfescape.com/signup/" },
    ],
    sections: [
      { heading: "Forms, annotations and signatures", body: [
        "PDFescape's free online tier covers everyday form jobs: filling existing forms, adding new form fields, commenting, marking up and adding text. Ultimate adds advanced forms, digital signing and sealing, and redaction, and its support pages say OCR is not available. Its help centre also notes that the free online editor can modify only text that was added in PDFescape.",
      ...
      { heading: "What happens to your documents", body: [
        "PDFescape is built around an online workspace: files you open are saved to a recent-files list on its servers so that you can come back to them, for seven days on the free tier. That suits a form you finish over several sessions. The Avanquest privacy policy linked from PDFescape says content is not retained, so read the product's own support pages for how stored files work.",
    ...
    tradeoffs: ["PDFescape's pages disagree on some details, such as which plan includes Print to PDF and which Windows versions Desktop supports; check the plan table before paying.", "PrivaTools' editor and form tools are separate steps, and its signatures are visible images; if you need certificate-based signing, choose a product that issues one.", "We did not benchmark either editor's output."],
    sources: [
      ...
      { label: "PDFescape terms", url: "https://www.pdfescape.com/terms/" },
      { label: "Avanquest privacy policy for PDFescape", url: "https://www.pdfescape.com/privacy/" },
    ],
  ...
  },
  {
    ...
    description: "Nitro PDF is a paid desktop editor for Windows and Mac with a 14-day trial; PrivaTools is free in the browser. Editing, OCR, signing and data handling compared.",
    summary: "Nitro sells PDF editing as annual subscriptions for Windows, macOS and iOS, a three-year Windows licence and separate Nitro Sign plans, after a 14-day trial with no card. It edits existing text with paragraph reflow, runs OCR and converts to Office formats. PrivaTools is free, needs no account and works in any browser, but it adds content rather than editing existing text, and it has no desktop app or signature-request service.",
    category: "Desktop & teams",
    highlights: ["Existing-text editing with reflow, which PrivaTools does not offer.", "A 14-day trial and then a subscription, against free with no account.", "Signature requests through Nitro Sign, against image signatures you place yourself."],
    overview: [
      "Nitro offers PDF software for Windows, macOS and iOS, a web workspace, and Nitro Sign for electronic signatures. Its pricing page lists Nitro PDF Standard and Plus subscriptions, a Nitro PDF Classic licence with a three-year term for the Windows desktop only, and Nitro Sign plans; its trial page calls the desktop product Nitro PDF Pro. Subscriptions bought online are billed annually.",
      "The 14-day trial covers the PDF apps, Nitro Sign and Nitro Workspace without a credit card; when it ends, the web-based conversion tools remain available and other features lock. Using the product otherwise needs an active subscription or licence. Nitro's compliance page lists ISO 27001 and SOC 2 among its certifications.",
    ],
    features: [
      ...
      { label: "File limits", privatools: "A 500 MB cap per upload request, so about 250 MB for one file on most pages.", competitor: "Its web-based tools take files up to 100 MB and 500 pages.", sourceUrl: "https://www.gonitro.com/user-guide/workspace/web-based-tools" },
      ...
      { label: "Account", privatools: "Not needed; an optional account issues API keys.", competitor: "An active Nitro subscription or licence is required to use the product.", sourceUrl: "https://www.gonitro.com/documentation/product-downloads" },
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "Proprietary: Nitro remains the sole owner of its software and IP.", sourceUrl: "https://www.gonitro.com/legal/pdf-sign/terms-of-service" },
    ...
    sections: [
      { heading: "Editing depth", body: [
        ...
        "PrivaTools approaches the same jobs as separate tools. Edit PDF draws new content over the page rather than changing existing text; OCR PDF adds a searchable text layer with a server or browser engine; PDF to Word extracts text line by line into an editable draft without rebuilding paragraphs or tables. For a document you revise every day, a desktop editor such as Nitro does more.",
      ] },
    ...
    choosePrivaTools: ["You need a quick task done without installing software or starting a trial.", "You work on Linux or another system Nitro's apps do not cover, using only a browser.", "You want image, audio, video and developer tools alongside PDFs, with open code."],
    tradeoffs: ["Nitro's own pages differ on some details, such as the iOS version it needs and where its data centres are; check the documentation for your platform before buying.", "Placing a signature image and running a signature-request service are different jobs; compare them separately.", "We did not benchmark editing accuracy, OCR quality or speed."],
    sources: [
  ...
  },
  {
    ...
    overview: [
      ...
      "Its pricing page says the tools are free to use without registration and lists optional paid plans, shown to us in Indian rupees, whose features include no ads, faster processing, no captcha and early access to new tools. Its privacy policy says uploaded files are deleted an hour after processing, and that analytics and third-party tracking are used to personalise the ads it serves.",
    ],
    features: [
      ...
      { label: "Where files are processed", privatools: "Developer and text tools run in your browser; file conversions run on PrivaTools' server in temporary storage.", competitor: "On its servers, hosted in the United States.", sourceUrl: "https://tinywow.com/privacy" },
      ...
      { label: "Ads and tracking", privatools: "No ad networks; Google Analytics is on by default with an off switch on the Privacy page.", competitor: "Analytics and third-party tracking are used to personalise the ads it serves.", sourceUrl: "https://tinywow.com/privacy" },
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "The terms say the underlying software is the property of TinyWow and its partners.", sourceUrl: "https://tinywow.com/tos" },
      { label: "Tool range", privatools: "PDF, image, audio, video, archive and developer tools, with on-device or own-key AI.", competitor: "Tools for PDFs, images, video, AI writing and file conversion.", sourceUrl: "https://tinywow.com/tools" },
    ],
    sections: [
      { heading: "Two different kinds of breadth", body: [
        "Both toolboxes are broad, in different directions. TinyWow's catalogue includes AI writing tools such as an AI humanizer, a PDF translator, e-signing, audio to text, background removal, a TikTok video downloader and a photo clean-up tool that removes unwanted objects from images. PrivaTools has no text generators or downloaders; its breadth is in file operations such as PDF editing and conversion, OCR, audio and video conversion, archives and developer formats, many of which run entirely in the browser.",
      ] },
      { heading: "How files are handled", body: [
        ...
        "PrivaTools labels each tool before it runs: browser tools keep the input on the device, and server tools write it to temporary per-request storage that is cleaned after the response. PrivaTools uses Google Analytics by default for page views and tool-run events, which never include file names or contents, and you can switch it off on the Privacy page.",
      ] },
    ],
    chooseCompetitor: ["You want AI writing or humanizing tools next to your file tools.", "You need its video downloader or its tool for removing objects from photos.", "You are happy with a free tier supported by ads, or want its paid plan for faster processing."],
    ...
    tradeoffs: ["TinyWow's own pages disagree on retention and on ads: its terms call the site ad-free, its privacy policy describes personalised ads, and its pricing page lists no ads as a paid feature.", "Its pricing page showed rupee and dollar prices side by side when we checked; confirm the currency at checkout.", "We did not benchmark output quality for either toolbox."],
    sources: [
  ...
  },
  {
    ...
    description: "ihatepdf.cv runs its PDF tools in the browser and sends chat text to Google Gemini; PrivaTools mixes browser and server tools under an MIT licence.",
    summary: "Both sites let you work without an account. ihatepdf.cv says its PDF tools run in the browser with WebAssembly, is free without ads and is funded by donations; its terms say the code is not open source. PrivaTools runs some tools in the browser and others on its server, covers images, media and developer tasks too, and publishes its code under the MIT licence.",
    category: "Local & self-hosted",
    highlights: ["Browser-first PDF tools, against a mix of browser and disclosed server tools.", "Proprietary code, against an MIT-licensed, self-hostable project.", "PDF chat through Google Gemini, against a choice of AI providers."],
    overview: [
      "ihatepdf.cv is a free collection of PDF and document tools that, by its own description, run in the web browser: its merge page says processing uses WebAssembly and files do not leave the device. Its about page names three tools that involve another party by design: Chat with PDF, P2P Share and a collaborative whiteboard.",
      "The site says it has no ads, no paid tier and no account, and is kept running by voluntary donations. It uses Microsoft Clarity to understand how pages are used, and its terms state that the software is not open source and that no licence to reuse it is granted.",
    ],
    features: [
      ...
      { label: "Where files are processed", privatools: "Each tool states whether it runs in your browser or uploads for temporary server processing.", competitor: "In the browser with WebAssembly; three tools involve another party by design.", sourceUrl: "https://www.ihatepdf.cv/about" },
      { label: "AI chat", privatools: "Extracted text goes from your browser to your chosen provider: Anthropic, OpenAI, Gemini, Mistral, DeepSeek, Together AI or a local server.", competitor: "Chat with PDF sends the extracted text to Google's Gemini API, using a key you supply.", sourceUrl: "https://www.ihatepdf.cv/chat-with-pdf" },
      ...
      { label: "Source code", privatools: "MIT-licensed and self-hostable.", competitor: "Its terms say it is not open source and grant no licence to reuse it.", sourceUrl: "https://www.ihatepdf.cv/terms" },
      ...
      { label: "Analytics", privatools: "Google Analytics on by default, with an off switch on the Privacy page; no file names or contents.", competitor: "Microsoft Clarity is used to understand how pages are used.", sourceUrl: "https://www.ihatepdf.cv/about" },
    ],
    sections: [
      { heading: "What local processing covers", body: [
        "ihatepdf.cv's merge page says files never leave the device because processing runs in WebAssembly, and it ties capacity to memory: typically 20 to 50 files, or about 150 MB in total, on a desktop browser. Its pages are not fully consistent about AI summaries: the homepage calls Summarize PDF on-device, while the tool's own page says extracted text is sent to an AI service. Read the page for the exact tool before sending anything sensitive.",
        "PrivaTools labels every tool. Developer utilities, text tools and several AI tools run in the browser; PDF conversions, the default OCR engine and media work run on the server, where inputs sit in temporary per-request storage and are cleaned after the response.",
      ] },
