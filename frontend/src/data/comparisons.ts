...
export const comparisons: ProductComparison[] = [
  ...
  },
  {
    ...
    highlights: ["Most free online tools allow one free transaction without signing in; PrivaTools has no transaction count, only a five-a-minute limit on heavy tools.", "Existing-text editing on paid plans, which PrivaTools does not offer.", "Certificate signatures and signature requests; PrivaTools places signature images only."],
    overview: [
