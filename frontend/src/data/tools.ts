...
const _toolsRaw: Tool[] = [
  ...
  },
  {
    ...
    metaDescription: "Metadata reads and lets you modify the Title, Author, Subject, and other fields embedded in a document. Free tool, see everything before sharing.",
  ...
  },
  {
    ...
    seoTitle: "Convert Markdown to PDF Online – Free and Fast",
    metaDescription: "Upload a markdown or text file and download a generated PDF with your formatting and links rendered. The file gets temporary server processing only.",
  ...
  },
  {
    ...
    metaDescription: "Place white rectangles over text, images, or any content to permanently hide it on the page. Free erasure tool built for quick coverups.",
