        ...
        return (
            ...
            >
                ...
                <div className="relative">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">PDF, images, video, archives, documents…</p>
                </div>
            </div>
        );
    }
            ...
            <div className="relative">
                <div className="flex items-center gap-3.5 px-5 py-4 border-b border-border/30">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-muted-foreground">{detectedTools.length} compatible tool{detectedTools.length !== 1 ? "s" : ""} found</p>
                    </div>
                    <button onClick={() => { setShow(false); setDetectedTools([]); }} className="text-muted-foreground hover:text-muted-foreground transition-colors">
                        <X size={15} />
                    </button>
                </div>
                ...
                {detectedTools.length > 0 ? (
                    ...
                    <div className="p-8 text-center">
                        <p className="text-[13px] text-muted-foreground">No compatible tools found for this file type</p>
                    </div>
                )}
            </div>
        </div>
