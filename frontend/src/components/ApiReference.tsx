...
export default function ApiReference() {
    ...
    return <section className="pt-api-reference" aria-labelledby="reference-title">
        <div className="pt-section-title"><h2 id="reference-title">The API reference.</h2><p>Browse request schemas, costs, and availability. No key needed to browse.</p></div>
        ...
        {catalog && <>
            ...
            <p role="status">{catalog.operations.length} documented operations{filtered.length !== catalog.operations.length && ` · ${filtered.length} matching`}</p>
