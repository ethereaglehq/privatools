...
export function ExtractArchiveUI() {
    ...
    async function extract() {
        ...
        } catch (e) { if (generation.current === current) setError(friendlyError(e instanceof Error ? e.message : "", "Couldn't open that archive.")); emitToolRun({outcome: "error", files: 1}); }
