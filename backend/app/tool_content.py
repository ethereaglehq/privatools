...
TOOL_HOWTO: dict[str, list[dict[str, str]]] = {
    ...
    "redact-pdf": [
        ...
        {"name": "Apply redactions and download", "text": "Click Redact. The text and image pixels under the boxes are removed from the file, not just covered, so removing a black box brings nothing back. The questions below say what redaction leaves in place."},
    ],
    "flatten-pdf": [
