...
TOOL_HOWTO: dict[str, list[dict[str, str]]] = {
    ...
    "bates-remove": [
        ...
        {"name": "Download the clean PDF", "text": "The matching stamps are removed. The page tells you if any it found could not be, such as a stamp drawn by an annotation or a form field, and how many other matches it left in place. You download a new PDF; the original on your device is not changed."},
    ],
    "accessibility-check": [
